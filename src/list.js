...
const data = [
  { name: "http://localhost:3000/api/read/5e47f99fb9570d1530799e63" },
  { name: "http://localhost:3000/read/5e6df828f86da5030aecead8" },
  { name: "http://localhost:3000/read/5e6df87ff86da5030aecf75c" },
];
export class RightList extends React.Component {
  ...
  componentDidMount() {
    let component = this;
    axios
      .get("https://netflix-hi7l.onrender.com/api/container/Movie/files")
    ...
    return (
      ...
      <div>
        {this.state.Movielist.map(function (d, idx) {
          ...
          return (
            <div
              ...
              cover={
                <Player
                  src={"https://netflix-hi7l.onrender.com/read/" + d._id}
                  width="426"
                  height="240"
                />
              }
        ...
        <Player
          width="426"
          height="240"
          src="https://netflix-hi7l.onrender.com/read/5ed36e35c80cb808ee742a2b"
        ></Player>
      </div>
    );
  }
