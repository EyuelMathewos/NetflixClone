...
export function* checkAuthAsync(action) {
  ...
  // yield axios.get( "https://netflix-hi7l.onrender.com/api/Accounts/5ff8597f1789ef0b1e6b1b39/accessTokens/p4gJGvml99VW5HHyrX4H6bARJiikyNNn5bzx9yl0EKfSTB3RXAQCF8wF9tftMhTj" )
  // .then(response => {
...
function* rootSaga() {
  yield all([helloSaga(), watchEmployeeListAsync()]);
}
